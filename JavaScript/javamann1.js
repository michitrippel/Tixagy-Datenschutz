function Wert3()
 {
   ...
   newArraymann[x] += 40*(1 - EA);
   
   var EB = 1 - EA;
   
   newArraymann[y] += 40*(-EB); 
...
do{
 ...
 var los3  = document.getElementById('button3');
los3.addEventListener ('click', Wert3, true);

newArraymann = new Array(1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,);